...
export default function AddSurveyForm({ route }: any) {
  ...
  const handleSave = async () => {
    try {
      // Prepare main survey data to pass to FloorDetailsScreen
      const mainSurveyData = {
        // Map formData fields to backend DTO structure as needed
        // This is a simplified example; adjust as per your DTOs
        surveyDetails: {
          // Fill with actual values from formData
        },
        propertyDetails: {
          // Fill with actual values from formData
        },
      ...
      navigation.navigate('FloorDetailsScreen', {
        mainSurveyData,
        surveyType,
      });
    } catch (error) {
      Alert.alert('Error', 'Failed to proceed to floor details.');
    }
  };
      ...
      <ScrollView>
        ...
        <View style={styles.section}>
          ...
          <FormDropdown
            ...
            required
            items={dummyMohalla}
            onValueChange={(value) => handleInputChange('mohalla', value)}
            value={formData.mohalla}
          />
          <FormInput
            label="Parcel ID"
            onChangeText={(value) => handleInputChange('parcelId', value)}
          ...
          <FormInput
            label="Map ID"
            required
            onChangeText={(value) => handleInputChange('mapId', value)}
          ...
          <FormInput
            label="GIS ID"
            required
            onChangeText={(value) => handleInputChange('gisId', value)}
            value={formData.gisId}
          />
          <FormInput
            label="Sub-GIS ID"
            onChangeText={(value) => handleInputChange('subGisId', value)}
        ...
        <View style={styles.section}>
          ...
          <FormInput
            label="Old House No."
            required
            onChangeText={(value) => handleInputChange('oldHouseNo', value)}
            value={formData.oldHouseNo}
          />
          <FormInput
          ...
          <FormInput
            ...
            onChangeText={(value) => handleInputChange('waterSewerageConnectionNo', value)}
            value={formData.waterSewerageConnectionNo}
          />
          <FormInput
          ...
          <FormDropdown
            ...
            required
            items={dummyRespondentStatus}
            onValueChange={(value) => handleInputChange('respondentStatus', value)}
        ...
        <View style={styles.section}>
          ...
          <FormDropdown
            label="Road Type"
            required
            items={dummyRoadTypes}
            onValueChange={(value) => handleInputChange('roadType', value)}
          ...
          <FormInput
            ...
            onChangeText={(value) => handleInputChange('fourWayEast', value)}
        ...
        <View style={styles.section}>
          ...
          <FormDropdown
            ...
            required
            items={dummyWaterSources}
            onValueChange={(value) => handleInputChange('sourceOfWater', value)}
          ...
          <FormDropdown
            ...
            required
            items={yesNoOptions}
            onValueChange={(value) => handleInputChange('rainWaterHarvesting', value)}
          ...
          {surveyType !== 'Residential' && (
            <>
              <FormDropdown
                ...
                required
                items={yesNoOptions}
                onValueChange={(value) => handleInputChange('plantationAvailable', value)}
                value={formData.plantationAvailable}
              />
              <FormDropdown
                label="Parking Available"
                required
                items={yesNoOptions}
                onValueChange={(value) => handleInputChange('parkingAvailable', value)}
              ...
              <FormDropdown
                ...
                required
                items={yesNoOptions}
                onValueChange={(value) => handleInputChange('pollutionCreated', value)}
                value={formData.pollutionCreated}
              />
              <FormInput
                label="Pollution Measurement"
                onChangeText={(value) => handleInputChange('pollutionMeasurement', value)}
                value={formData.pollutionMeasurement}
              />
            </>
          )}
          ...
          <FormDropdown
            ...
            required
            items={yesNoOptions}
            onValueChange={(value) => handleInputChange('waterSupplyWithin200m', value)}
            value={'' + formData.waterSupplyWithin200m}
          />
          <FormDropdown
            label="Sewerage Line within 100m"
            required
            items={yesNoOptions}
            onValueChange={(value) => handleInputChange('sewerageLineWithin100m', value)}
            value={'' + formData.sewerageLineWithin100m}
          />
          <FormDropdown
            label="Disposal Type"
            required
            items={dummyDisposalTypes}
            onValueChange={(value) => handleInputChange('disposalType', value)}
