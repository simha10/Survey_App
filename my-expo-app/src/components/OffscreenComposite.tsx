...
const OffscreenComposite = forwardRef<View, Props>(({ uri, width, height, latitude, longitude, timestamp }, ref) => {
  ...
  return (
    <View ref={ref} style={{ width, height, backgroundColor: 'black' }}>
      <RNImage source={{ uri }} style={{ width, height, position: 'absolute' }} resizeMode="cover" />
      <View
        style={{
          position: 'absolute',
          left: 0,
